...
import Resume from '../Resume/Shrey-Srivastava-Resume.pdf'
    ...
    return (
        <Box>
                ...
                <Flex flexDirection={['column-reverse', 'column-reverse', 'row']} m="auto" justifyContent="space-around" alignItems="center" h="100%">
                    <Box data-aos="fade-down">
                        ...
                        <Box className='content'>
                            <Heading fontSize="3.3em" className='text' data-text="Shrey Srivastava"><span className='themeText'>Shrey Srivastava</span></Heading>
                        </Box>
                        ...
                        <HStack className='hireMe' onClick={() => { window.open("https://1drv.ms/b/s!AjfSNL-3_Mfng0dVyp7QsLXQT92h?e=uncCFn", '_blank') }}>
                            <a href={Resume} download="Shrey-Srivastava-Resume">
                    ...
                    <Flex data-aos="fade-left">
                        <Flex w="100%" gap="10%" justifyContent="center">
                            <Image
                                borderRadius='full'
                                boxSize='250px'
                                src='https://user-images.githubusercontent.com/84815622/236336018-c67135d5-c818-4612-b90a-a2800eefbd54.jpeg'
                                alt='Dan Abramov' />
            ...
            <Box id="githubStats">
                ...
                <Center>
                    <Image src="https://github-readme-stats.vercel.app/api/top-langs/?username=Shrey-Srivastava21&layout=compact&hide_border=true&theme=radical" alt="Most used languages" />
                </Center>

                <Center className='github-stats'>
                    <Image src="https://github-readme-stats.vercel.app/api?username=Shrey-Srivastava21&show_icons=true&locale=en&layout=compact&hide_border=true&theme=radical" alt="Github stats" />
                    <Image src="https://github-readme-streak-stats.herokuapp.com/?user=Shrey-Srivastava21&layout=compact&hide_border=true&theme=radical" alt="Current Streaks" />
                </Center>

                <Center>
                    <GitHubCalendar username="Shrey-Srivastava21" color="#4a8af4" children={<ReactTooltip html />} />
                </Center>
            </Box>
                    ...
                    <Box className='form-section'>
                        ...
                        <Flex className='contact-info'>
                            <HStack>
                                ...
                                <Text>demonshrey.1738@gmail.com</Text>
                            </HStack>
                            <HStack>
                                <FaPhoneAlt color="#00a14f" />
                                <Text>+91 63920 98133</Text>
                            </HStack>
                        </Flex>
                        <Flex gap={["10px", "20px", "20px", "40px"]}>
                            ...
                            <Link href='https://www.linkedin.com/in/shrey-srivastava21/' target="_blank">
                                <Tooltip label='Shrey Srivastava'>
                                    <Box className='social-icons'>
                                        <Box>
                            ...
                            <Link href="https://github.com/Shrey-Srivastava21" target="_blank">
                                <Tooltip label='Shrey-Srivastava21'>
                                    <Box className='social-icons'>
                                        <Box>
                            ...
                            <Link href="mailto:demonshrey.1738@gmail.com" target="_blank">
                                <Tooltip label='demonshrey.1738@gmail.com'>
                                    <Box className='social-icons'>
                                        <Box>
            ...
            {/* footer */}
            <Flex id='footer'>
                <Text>© Portfolio by Shrey Srivastava. | All rights reserved.</Text>
                <Text>Made with 💖 by Shrey Srivastava</Text>
            </Flex>
        </Box >
    )
}
